<!-- AI-generated repo summary (inserted at the top of the README) -->

# About This Repo (AI Summary)

This repo is **AIxBDD (aixbdd)** — a set of AI agent skills that implement a BDD (Behavior-Driven Development) workflow with clearly separated PM and RD (developer) responsibilities.
